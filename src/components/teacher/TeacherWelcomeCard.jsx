...
const TeacherWelcomeCard = ({ stats = null }) => {
  const { user } = useAuth()
  ...
  const totalExams = Number(safeStats.totalExams || 0)
  const activeExams = Number(safeStats.activeExams || 0)
  const totalStudents = Number(safeStats.totalStudents || 0)
    ...
    return (
      <motion.div
        ...
        style={{
          ...
          padding: '32px 40px', color: '#e6edf3',
        }}
      >
        <div style={{
        ...
        <div style={{ position: 'relative', zIndex: 1 }}>
            ...
            <div className="flex-1">
              <motion.div
                ...
                style={{
                  ...
                  padding: '6px 14px', marginBottom: '16px', borderRadius: '9999px',
              ...
              >
                ...
                <span style={{ fontSize: '12px', fontWeight: 600, color: '#3fb950' }}>Alice AI Proctoring Active</span>
              </motion.div>
              ...
              >
                {greeting}, <br />
                <span style={{ color: '#3fb950' }}>{user?.name || 'Teacher'}</span>
              </motion.h2>
              ...
              >
                Your exams are protected by Alice AI. Monitor your students and keep everything on track!
              </motion.p>
            </div>

            <motion.div
              initial={{ opacity: 0, scale: 0.8 }} animate={{ opacity: 1, scale: 1 }}
              transition={{ delay: 0.5, type: 'spring' }} className="hidden lg:block"
            >
              <div className="relative w-32 h-32">
                <motion.div animate={{ rotate: 360 }} transition={{ duration: 20, repeat: Infinity, ease: 'linear' }}
                  style={{ position: 'absolute', inset: 0, borderRadius: '50%', border: '3px solid transparent', borderTopColor: '#2ea043', borderRightColor: 'rgba(46,160,67,0.3)' }}
                />
                <motion.div animate={{ rotate: -360 }} transition={{ duration: 15, repeat: Infinity, ease: 'linear' }}
                  style={{ position: 'absolute', inset: '12px', borderRadius: '50%', border: '2px solid transparent', borderBottomColor: '#3fb950', borderLeftColor: 'rgba(63,185,80,0.2)' }}
                />
                <div style={{ position: 'absolute', inset: 0, display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
                  <div style={{ width: 56, height: 56, borderRadius: '14px', backgroundColor: 'rgba(46,160,67,0.1)', border: '1px solid rgba(46,160,67,0.3)', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
                ...
                <motion.div animate={{ y: [-5, 5, -5] }} transition={{ duration: 3, repeat: Infinity, ease: 'easeInOut' }}
                  style={{ position: 'absolute', top: -8, right: -8, width: 36, height: 36, borderRadius: '10px', backgroundColor: 'rgba(46,160,67,0.15)', border: '1px solid rgba(46,160,67,0.3)', display: 'flex', alignItems: 'center', justifyContent: 'center' }}
                >
                  <FiEye style={{ width: 16, height: 16, color: '#3fb950' }} />
                </motion.div>
                <motion.div animate={{ y: [5, -5, 5] }} transition={{ duration: 3, repeat: Infinity, ease: 'easeInOut', delay: 1 }}
                  style={{ position: 'absolute', bottom: -8, left: -8, width: 36, height: 36, borderRadius: '10px', backgroundColor: 'rgba(46,160,67,0.15)', border: '1px solid rgba(46,160,67,0.3)', display: 'flex', alignItems: 'center', justifyContent: 'center' }}
                >
          ...
          >
            {[
              ...
              <div key={label} style={{ padding: '16px', borderRadius: '12px', backgroundColor: 'rgba(46,160,67,0.06)', border: '1px solid rgba(46,160,67,0.2)' }}>
  ...
  return (
    <motion.div
      ...
      className="relative overflow-hidden rounded-3xl bg-gradient-to-br from-emerald-600 via-teal-600 to-cyan-600 p-8 md:p-10 text-white shadow-2xl"
    >
        ...
        <div className="flex items-start justify-between gap-6">
          <div className="flex-1">
            ...
            >
              ...
              <span className="text-sm font-semibold">Alice AI Proctoring Active</span>
            </motion.div>
          ...
          <motion.div initial={{ opacity: 0, scale: 0.8, rotate: -10 }} animate={{ opacity: 1, scale: 1, rotate: 0 }}
            transition={{ delay: 0.5, type: 'spring' }} className="hidden lg:block"
          >
            <div className="relative w-32 h-32">
