...
export default function Profile() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // Update local user state in AuthContext if available
        ...
        >
          ...
          <div className="relative flex flex-col md:flex-row items-center gap-6" style={{ transform: 'translateZ(50px)' }}>
            ...
            <div className="text-center md:text-left flex-1">
              ...
              >
                {profileData?.name || user?.username || 'Teacher Name'}
              </motion.h2>
              <motion.p 
              ...
              <div className="mt-6 flex flex-wrap gap-3 justify-center md:justify-start">
                {[
                  { label: 'Teacher ID: TCH2026001', color: 'from-blue-400 to-blue-600' },
                  { label: 'Active', color: 'from-green-400 to-green-600' },
                  ...(profileData?.department ? [{ label: profileData.department, color: 'from-purple-400 to-purple-600' }] : [])
                ].map((badge, index) => (
                  <motion.span
                    key={index}
            ...
            >
              <Edit2 className="w-6 h-6 drop-shadow-lg" />
            </motion.button>
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          {stats.map((stat, index) => {
            ...
            return (
              ...
              >
                <Icon className={`w-8 h-8 text-${stat.color}-600 dark:text-${stat.color}-400 mb-3`} />
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="font-semibold text-gray-900 dark:text-white">{profileData?.name || 'Not set'}</p>
              </div>
            </div>
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="font-semibold text-gray-900 dark:text-white">{profileData?.email || 'Not set'}</p>
              </div>
            </div>
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="font-semibold text-gray-900 dark:text-white">{profileData?.phone || 'Not set'}</p>
              </div>
            </div>
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="font-semibold text-gray-900 dark:text-white">{profileData?.location || 'Not set'}</p>
              </div>
            </div>
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="font-semibold text-gray-900 dark:text-white">{profileData?.department || 'Not set'}</p>
              </div>
            </div>
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="font-semibold text-gray-900 dark:text-white">{profileData?.specialization || 'Not set'}</p>
              </div>
            </div>
          </div>
        </motion.div>
